...
import numpy as np
from bspf_jax.gyrokinetic_slab import (plan_slab_gk,slab_gk_rhs,slab_gk_fields,
    integrate_slab_gk,slab_gk_diagnostics)
...
def test_analytic_free_energy_and_source_power():
    from bspf_jax.gyrokinetic_slab import slab_gk_source_rates
