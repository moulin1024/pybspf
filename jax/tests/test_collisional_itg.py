...
from bspf_jax.nonlinear_itg import nonlinear_itg_initial,nonlinear_itg_project,nonlinear_itg_diagnostics,nonlinear_itg_rhs
from bspf_jax.collisional_itg import (plan_collisional_itg,collisional_itg_collision,
    collisional_itg_rhs,collisional_itg_rates,collisional_itg_transport,integrate_collisional_itg)
...
def test_gyroaveraged_bgk_matches_particle_angle_projection(p):
    from bspf_jax.nonlinear_itg import nonlinear_itg_fields
