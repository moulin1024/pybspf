...
from bspf_sim.air_sea.platform import SpatialConfig
from bspf_sim.air_sea.platform import TimeConfig
from bspf_sim.air_sea.platform import OutputConfig
...
def test_failure_evidence_and_config_tamper(tmp_path, config, monkeypatch):
    import bspf_sim.air_sea.platform as module
