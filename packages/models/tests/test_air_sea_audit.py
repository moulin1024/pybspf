...
from bspf_models.air_sea.air_sea_audit import process_rhs
...
def test_stage_failure_location_catalog(plan):
    from bspf_models.air_sea.air_sea_audit import StageObservation
    from bspf_models.air_sea.air_sea_audit import observe_stage
