...
from bspf_models.elliptic.convex_poisson_tensor import PoissonIterationError
from bspf_models.elliptic.convex_poisson_tensor import trace_adjoint
...
def test_persistent_cache_and_fixed_grid(tmp_path, monkeypatch):
    ...
    from bspf_models.elliptic.convex_poisson_tensor import _line
    ...
    monkeypatch.setattr("bspf_models.elliptic.convex_poisson_tensor._stream_line", unexpected)
    monkeypatch.setattr(
        "bspf_models.elliptic.convex_poisson_tensor.stream_evaluate_line", unexpected
    )
    monkeypatch.setattr("bspf_models.elliptic.convex_poisson_tensor.la.svd", unexpected)
