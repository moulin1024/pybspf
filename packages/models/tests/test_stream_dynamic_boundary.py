...
from bspf_models.fluids.stream_navier_stokes import stream_ns_open_velocity
...
from bspf_models.fluids.stream_navier_stokes import stream_ns_boundary_load
