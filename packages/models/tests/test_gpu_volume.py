...
from bspf_models.fluids._immersed_assembly import _tensor_operators
from bspf_models.fluids._immersed_assembly import _prepare_volume
...
def test_resident_volume_fields_match_direct_tensor_contractions(rational, constrained, consume, monkeypatch):
    monkeypatch.setattr("bspf_models.fluids._immersed_assembly._FUSED_OPERATOR_BYTES", 0)
    try:
