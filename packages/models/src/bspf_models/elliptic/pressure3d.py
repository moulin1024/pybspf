...
import numpy as np
from bspf_models._numerics.trial_spaces import PressureLine
from bspf_models._numerics.trial_spaces import _make_line
from bspf_models.elliptic.pressure import _differentiate
from bspf_models.elliptic.pressure import _transform
from bspf_models.elliptic.pressure import _lift_vectors
