...
from bspf_models._numerics.trial_spaces import PressureLine, _fourier, _line_projector, _make_line
...
def compress_pressure_plan(
    ...
    Optional SciPy host preprocessing; install pybspf[host]. Application
