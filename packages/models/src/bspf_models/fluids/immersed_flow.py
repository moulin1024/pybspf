...
from bspf_models._numerics._weak_basis import with_basis_workers
...
from bspf_models.fluids.stream_navier_stokes import _smooth_step
...
class ImmersedFlowPlan:
        ...
        *,
        ...
        if self.rational_wall:
            ...
            if rational_preprocessing is not False:
                ...
                from bspf_models.fluids._rational_preprocess import prepare_extension
                ...
                def audit_data(data):
                    ...
                    if assembly_device is None:
                        ...
                        from bspf_models.fluids._immersed_assembly import _apply_rational_rows
        ...
        if device_volume:
            from bspf_models.fluids._immersed_assembly import prepare_gpu_volume
        ...
        assembly = None
        if assembly_device is not None:
            from bspf_models.fluids._immersed_assembly import GPUVolumeAssembly
    ...
    def operators(self, points, *, with_base=False, device_output=False):
        ...
        if device_output:
            ...
            from bspf_models.fluids._immersed_assembly import gpu_tensor_operators
    ...
    def stepper(self, dt, *, device=None):
        ...
        if device is not None:
            from bspf_models.fluids.immersed_flow_gpu import GPUImmersedFlowStepper
