...
from bspf_models._numerics.trial_spaces import StreamLine, _stream_line, stream_evaluate_line
...
from bspf_models._numerics.trial_spaces import _line_projector
